    ...
    !(function (n,e) {
        function setAtag() {
            ...
            aTags.forEach(item =>{
                ...
                // Закомментировано: проверка доменов segway/ninebot
    ...
    !(function (n,e) {
        function updateFavicon() {
            ...
            if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
                ...
                favicon.href = '/assets/img/favicon_white.svg'; // Изменен путь - убрана привязка к segway-ninebot
            } else {
                // favicon.href = '/etc.clientlibs/segway-ninebot/clientlibs/clientlib-base/img/resources/favicon_black.svg'; // 亮色模式图标
                favicon.href = '/assets/img/favicon_black.svg'; // Изменен путь - убрана привязка к segway-ninebot
            }
        }
        // 初始调用
        updateFavicon();
